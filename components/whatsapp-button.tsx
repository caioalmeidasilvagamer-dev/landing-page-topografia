  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        className="relative flex items-center justify-center size-12 sm:size-14 rounded-full shadow-lg transition-shadow duration-200 hover:shadow-xl"
      ...
      >
        ...
        />
        <svg viewBox="0 0 24 24" fill="white" width="24" height="24" className="sm:w-7 sm:h-7 relative z-10">
